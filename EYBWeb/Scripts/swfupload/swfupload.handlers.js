    ...
    try {
        ...
        if (jsonstr.status == '1') {
            ...
            if (this.customSettings.button_action == SWFUpload.BUTTON_ACTION.SELECT_FILE) {
                ...
                addImageSingle($(this.customSettings.upload_target), jsonstr.path, jsonstr.thumb);
            } else {
...
//======================================上传头像======================================
function addImageSingle(targetObj, originalSrc, thumbSrc) {
    ...
    + '<div  onclick="setFocusImg(this);" >'
    + '<img src="' + thumbSrc + '" bigsrc="' + originalSrc + '"  width=120 height=120 />'
    ...
    $("#hid_photo_name1").val(originalSrc);


    if ($("#headerImg") != undefined) {
        $("#headerImg").attr("src", originalSrc);
    }
}
//======================================图片相册处理事件======================================
//添加图片相册
function addImage(targetObj, originalSrc, thumbSrc) {
    ...
    + '<img src="' + thumbSrc + '" bigsrc="' + originalSrc + '"  width=140 height=140 />'
