...
function PayMoney() {
    ...
    var RedirectUrl = "/CashManage/PayRechargeproject"
    ...
    $.ajax({
        ...
        url: RedirectUrl,
        data: { "IDList": IDList, "Price": cashamout, "shouxufei": shouxufei, "Memo": txtmemo, "TimesList": TimesList, "HuankuanList": HuankuanList, "UserIDList": UserIDList, "UserID": UserID, "Xianjin": txtCash, "Yinlianka": txtyingliancard, "Chuzhika": txtChuzhikaValue, "txtChuzhikaarr": txtChuzhikaarr.toString(), "OtherPayment": OtherPayment.toString(), "IsGiveValue": IsGiveValue.toString(), "IsCashValue": IsCashValue.toString(), "OtherPaymentValue": OtherPaymentValue.toString() },
        async: false,
