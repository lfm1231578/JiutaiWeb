$(function () {
    ...
    $.swfUpLoadDefaults.property = {
        ...
        sendurl: null, //发送地址
        filetypes: "*.jpg;*.jpge;*.png;*.gif;*.rar;*.zip;*.doc;*.pdf;*.xls;*.docx;", //文件类型
        filesize: "2048", //文件大小
        btntext: "浏览...", //上传按钮的文字
        btnwidth: 48, //上传按钮的宽度
        btnheight: 25, //上传按钮的高度
    ...
    $.fn.InitSWFUpload = function (p) {
        ...
        var swfu = new SWFUpload({
            ...
            button_text_style: ".btnText{font-family:Microsoft YaHei;font-size:12px;line-height:28px;color:#333333;text-align:center; margin-top:10px }", //按钮样式
