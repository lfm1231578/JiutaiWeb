...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        var dfop =
            {
                ...
                datatype: "json",
                url: false,
                cbiconpath: "../Content/images/tree/",
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (deep == 1) {
                ht.push("<img class='bbit-tree-icon' src='../../Content/Images/tree/s.gif'/>");
            }
            else if (deep > 1) {
                ht.push("<img class='bbit-tree-icon' src='../../Content/Images/tree/s.gif'/>");
                for (var j = 1; j < deep; j++) {
                    ht.push("<img class='bbit-tree-elbow-line' src='../../Content/Images/tree/s.gif'/>");
                }
            }
            ht.push("</span>");
            //img
            ...
            ht.push("<img class='bbit-tree-ec-icon ", cs.join(" "), "' src='../../Content/Images/tree/s.gif'/>");
            ht.push("<img class='bbit-tree-node-icon' src='../../Content/Images/tree/s.gif'/>");
            //checkbox
        ...
        function nodeclick(e) {
            ...
            if (et.tagName == "IMG") {
                ...
                dfop.citem = item;
                $(".bbit-tree-node").find(".bbit-tree-node-el").removeClass("bbit-tree-selected");
        ...
        function builparam(node) {
            var p = [{ name: "id", value: encodeURIComponent(node.id) }
                    ...
                    , { name: "memo", value: encodeURIComponent(node.memo) }
